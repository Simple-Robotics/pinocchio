...
namespace pinocchio
{
  ...
  template void updateFramePlacements<context::Scalar, context::Options, JointCollectionDefaultTpl>(
    const context::Model &, context::Data &);

  template const SE3Tpl<context::Scalar, context::Options> &
  ...
  template MotionTpl<context::Scalar, context::Options>
