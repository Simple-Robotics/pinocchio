...
namespace pinocchio
{
  namespace python
  {
    ...
    static std::size_t computeDistances_proxy(const ModelTpl<Scalar,Options,JointCollectionTpl> & model,
    ...
    void exposeCollision()
    {
      ...
      bp::def("computeDistances",
              &computeDistances_proxy<double,0,JointCollectionDefaultTpl,VectorXd>,
