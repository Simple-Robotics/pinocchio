...
namespace pinocchio
{
  ...
  namespace impl
  {
    extern template PINOCCHIO_DLLAPI const context::Vector3 & centerOfMass<
      context::Scalar,
      context::Options,
  ...
  extern template PINOCCHIO_DLLAPI const context::Vector3 &
  ...
  namespace impl
  {
    extern template PINOCCHIO_DLLAPI const context::Matrix3x & jacobianCenterOfMass<
      context::Scalar,
      context::Options,
      JointCollectionDefaultTpl,
      Eigen::Ref<const context::VectorXs>>(
    ...
    extern template PINOCCHIO_DLLAPI void jacobianSubtreeCenterOfMass<
      context::Scalar,
      context::Options,
      JointCollectionDefaultTpl,
      Eigen::Ref<const context::VectorXs>,
    ...
    extern template PINOCCHIO_DLLAPI void getJacobianSubtreeCenterOfMass<
      context::Scalar,
      context::Options,
      JointCollectionDefaultTpl,
      Eigen::Ref<context::Matrix3x>>(
  ...
  extern template PINOCCHIO_DLLAPI const context::Matrix3x &
