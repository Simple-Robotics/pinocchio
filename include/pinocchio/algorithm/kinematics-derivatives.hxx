...
namespace pinocchio
{
  namespace impl
  {
    ...
    : public fusion::JointUnaryVisitorBase<ForwardKinematicsDerivativesForwardStepOrder1<
        Scalar,
        Options,
        JointCollectionTpl,
        ConfigVectorType,
      ...
      const Eigen::MatrixBase<TangentVectorType> & v)
    {
      ...
      typedef ForwardKinematicsDerivativesForwardStepOrder1<
...
#undef GET_ANGULAR
    ...
    const Eigen::MatrixBase<TangentVectorType> & v)
  {
    impl::computeForwardKinematicsDerivatives(
      model, data, make_const_ref(q.derived()), make_const_ref(v.derived()));
  }
