...
namespace pinocchio
{
  namespace python
  {
    ...
    : public boost::python::def_visitor< TridiagonalSymmetricMatrixPythonVisitor<TridiagonalSymmetricMatrix> >
    {
    ...
    public:
      ...
      void visit(PyClass& cl) const
      {
        ...
        .def(bp::init<Eigen::DenseIndex>
             ((bp::arg("self"),bp::arg("size")),
              "Default constructor from a given size."))
#ifndef PINOCCHIO_PYTHON_SKIP_COMPARISON_OPERATIONS
        .def(bp::self == bp::self)
        .def(bp::self != bp::self)
#endif
        .def("diagonal",(CoeffVectorType & (TridiagonalSymmetricMatrix::*)())&TridiagonalSymmetricMatrix::diagonal,bp::arg("self"),
             "Reference of the diagonal elements of the symmetric tridiagonal matrix.",
             bp::return_internal_reference<>())
        .def("subDiagonal",(CoeffVectorType & (TridiagonalSymmetricMatrix::*)())&TridiagonalSymmetricMatrix::subDiagonal,bp::arg("self"),
...
#endif
        bp::class_<TridiagonalSymmetricMatrix,HolderType>("TridiagonalSymmetricMatrix",
