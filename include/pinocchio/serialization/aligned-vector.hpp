...
namespace boost
{
  ...
  namespace serialization
  {
    ...
    template<class T>
    inline const fixme::nvp<typename pinocchio::container::aligned_vector<T>::vector_base>
...
#else
    template<class T>
    inline const nvp<typename pinocchio::container::aligned_vector<T>::vector_base>
    make_nvp(const char * name, pinocchio::container::aligned_vector<T> & t)
    {
      typedef typename pinocchio::container::aligned_vector<T>::vector_base vector_base;
