...
namespace Eigen {
  namespace internal {
    ...
    template<typename TridiagonalSymmetricMatrix, typename MatrixDerived>
    struct traits<pinocchio::TridiagonalSymmetricMatrixApplyOnTheRightReturnType<TridiagonalSymmetricMatrix,MatrixDerived>>
    ...
    template<typename TridiagonalSymmetricMatrixInverse, typename MatrixDerived>
    struct traits<pinocchio::TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType<TridiagonalSymmetricMatrixInverse,MatrixDerived>>
    : public traits<typename pinocchio::traits<pinocchio::TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType<TridiagonalSymmetricMatrixInverse,MatrixDerived>>::PlainMatrixType>
    {
      typedef pinocchio::traits<pinocchio::TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType<TridiagonalSymmetricMatrixInverse,MatrixDerived>> Base;
      typedef typename Base::PlainMatrixType ReturnType;
      enum { Flags = 0 };
    };
...
namespace pinocchio
{
  ...
  : public Eigen::ReturnByValue<TridiagonalSymmetricMatrixTpl<_Scalar,_Options> >
  {
    ...
    CoeffVectorType & diagonal() { return m_diagonal; }
    const CoeffVectorType & diagonal() const { return m_diagonal; }
    CoeffVectorType & subDiagonal() { return m_sub_diagonal; }
    const CoeffVectorType & subDiagonal() const { return m_sub_diagonal; }
    ...
    void setDiagonal(const Eigen::MatrixBase<VectorCoeffType> & diagonal_coefficients)
    {
      ...
      static_assert(VectorCoeffType::IsVectorAtCompileTime, "VectorCoeffType should be a vector type at compile time");
  ...
  struct TridiagonalSymmetricMatrixApplyOnTheRightReturnType
  : public Eigen::ReturnByValue<TridiagonalSymmetricMatrixApplyOnTheRightReturnType<TridiagonalSymmetricMatrix,RhsMatrixType> >
  {
    typedef TridiagonalSymmetricMatrixApplyOnTheRightReturnType Self;
    typedef typename traits<Self>::PlainMatrixType PlainMatrixType;
    
    TridiagonalSymmetricMatrixApplyOnTheRightReturnType(const TridiagonalSymmetricMatrix & lhs,
    ...
    inline void evalTo(ResultType& result) const
    {
      ...
      result.noalias() = m_lhs.diagonal().asDiagonal() * m_rhs;
        // Upper diagonal
      result.topRows(reduced_size).noalias() += m_lhs.subDiagonal().conjugate().asDiagonal() * m_rhs.bottomRows(reduced_size);
        // Sub diagonal
      result.bottomRows(reduced_size).noalias() += m_lhs.subDiagonal().asDiagonal() * m_rhs.topRows(reduced_size);
    }
  ...
  : public Eigen::ReturnByValue<TridiagonalSymmetricMatrixInverse<_TridiagonalSymmetricMatrix> >
  {
    ...
    explicit TridiagonalSymmetricMatrixInverse(const TridiagonalSymmetricMatrix & tridiagonal_matrix)
    ...
    applyOnTheRight(const Eigen::MatrixBase<MatrixDerived> & mat) const
    {
      typedef TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType<Self,MatrixDerived> ReturnType;
      return ReturnType(*this,mat.derived());
    }
  ...
  struct TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType
  : public Eigen::ReturnByValue<TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType<TridiagonalSymmetricMatrixInverse,RhsMatrixType> >
  {
    typedef TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType Self;
    typedef typename traits<Self>::PlainMatrixType PlainMatrixType;
    
    TridiagonalSymmetricMatrixInverseApplyOnTheRightReturnType(const TridiagonalSymmetricMatrixInverse & lhs,
                                                               const RhsMatrixType & rhs)
    : m_lhs(lhs)
    , m_rhs(rhs)
    {}
